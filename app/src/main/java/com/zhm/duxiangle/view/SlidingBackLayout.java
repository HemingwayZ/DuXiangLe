...
public class SlidingBackLayout extends FrameLayout {
    ...
    public SlidingBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        // 设置阴影
        mShadowDrawable = getResources().getDrawable(R.drawable.hm_shadow_left);
    }
...
//        Log.i(TAG, "mViewPager = " + mViewPager);
    ...
    private void scrollRight() {
        ...
        //-delta-mShadowDrawable.getIntrinsicWidth()：使用这个参数将contentVCiew和阴影部分都带出窗口--zhm
        mScroller.startScroll(mContentView.getScrollX(), 0, -delta-mShadowDrawable.getIntrinsicWidth(), 0,
                Math.abs(delta));
        postInvalidate();
    }
