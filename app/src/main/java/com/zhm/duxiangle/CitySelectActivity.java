...
import android.widget.TextView;
        ...
        import com.zhm.duxiangle.view.MyGridView;


public class CitySelectActivity extends SlidingBackActivity {
    private Button btn_province0, btn_city0, btn_county0, btn_province1,
            btn_city1, btn_county1;
    private MyGridView grid_start0, grid_start1, grid_start2,
            grid_destination0, grid_destination1, grid_destination2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        loadGridView();
        selectAndChange(grid_start0, province_adapter, R.array.province_item);
        grid_start0.setVisibility(View.GONE);
        selectAndChange(grid_destination0, province_adapter,
                R.array.province_item);
        grid_destination0.setVisibility(View.GONE);
    }

    private void loadGridView() {
        // 出发地
        btn_province0.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!grid_start0.isShown()) {
                    selectAndChange(grid_start0, province_adapter,
                            R.array.province_item);
                    grid_start0.setVisibility(View.VISIBLE);
                    if (provinceId != -1) {
                        // grid_start0.getItemAtPosition(provinceId);
                        // TextView aView =
                        // (TextView)findViewById(R.id.text_adapter_item);
                        // aView.setBackgroundResource(R.drawable.icon_city);
                    }
                    btn_province0
                            .setBackgroundResource(R.drawable.icon_province);
                    grid_start1.setVisibility(View.GONE);
                    btn_city0
                            .setBackgroundResource(R.drawable.icon_province);
                    grid_start2.setVisibility(View.GONE);
                    btn_county0
                            .setBackgroundResource(R.drawable.icon_province);
                } else {
                    grid_start0.setVisibility(View.GONE);
        ...
        btn_city0.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (btn_province0.getText().equals("省份")) {
                    ...
                    if (!grid_start1.isShown()) {
                        grid_start1.setVisibility(View.VISIBLE);
                        btn_city0
                                .setBackgroundResource(R.drawable.icon_city);
                        grid_start0.setVisibility(View.GONE);
                        btn_province0
                                .setBackgroundResource(R.drawable.icon_province);
                        grid_start2.setVisibility(View.GONE);
        ...
        btn_county0.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if ((!btn_province0.getText().equals("省份"))&&btn_city0.getText().equals("城市")) {
                    AlertDialog dialog = new AlertDialog.Builder(
                            CitySelectActivity.this)
                            .setMessage("请先选择城市")
                            .setPositiveButton("确定",
                    ...
                    dialog.show();
                } else if(btn_province0.getText().equals("省份")&&btn_city0.getText().equals("城市")){
                    AlertDialog dialog = new AlertDialog.Builder(
                            CitySelectActivity.this)
                            .setMessage("请先选择省份")
                            .setPositiveButton("确定",
                    ...
                    if (!grid_start2.isShown()) {
                        grid_start2.setVisibility(View.VISIBLE);
                        btn_county0
                                .setBackgroundResource(R.drawable.icon_city);
                        grid_start0.setVisibility(View.GONE);
                        btn_province0
        ...
        grid_start0.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                provinceId = arg2;
                TextView textView = (TextView) arg1
                        .findViewById(R.id.text_adapter_item);
                strProvince = (String) textView.getText();
                if (!btn_province0.getText().equals(strProvince)) {
                    grid_start1.setVisibility(View.GONE);
                    btn_city0
                            .setBackgroundResource(R.drawable.icon_province);
                    grid_start2.setVisibility(View.GONE);
                    btn_county0
                            .setBackgroundResource(R.drawable.icon_province);
                    btn_city0.setText("城市");
                    btn_county0.setText("区县");
                }
                Log.e("test", "province: " + arg2 + strProvince);
                loadGridViewData(grid_start0, grid_start1, city_adapter,
                        city[arg2]);
                btn_province0.setText(strProvince);
                btn_province0
                        .setBackgroundResource(R.drawable.icon_province);
            }
        });
        grid_start1.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                cityId = arg2;
                TextView textView = (TextView) arg1
                        .findViewById(R.id.text_adapter_item);
                strCity = (String) textView.getText();
                if (!btn_city0.getText().equals(strCity)) {
                    grid_start2.setVisibility(View.GONE);
                    btn_county0
                            .setBackgroundResource(R.drawable.icon_province);
                    btn_county0.setText("区县");
                }
                btn_city0.setText(strCity);
                btn_city0
                        .setBackgroundResource(R.drawable.icon_province);
                Log.e("test", "city: " + arg2 + strCity);
                switch (provinceId) {
                    case 0:
                        loadGridViewData(grid_start1, grid_start2, county_adapter,
        ...
        grid_start2.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                TextView textView = (TextView) arg1
                        .findViewById(R.id.text_adapter_item);
                strCounty = (String) textView.getText();
                Log.e("test", "county: " + arg2 + strCounty);
                btn_county0.setText(strCounty);
                grid_start2.setVisibility(View.GONE);
                btn_county0
                        .setBackgroundResource(R.drawable.icon_province);
            }
        ...
        // 目的地
        btn_province1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!grid_destination0.isShown()) {
                    selectAndChange(grid_destination0, province_adapter,
                            R.array.province_item);
                    grid_destination0.setVisibility(View.VISIBLE);
                    btn_province1
                            .setBackgroundResource(R.drawable.icon_province);
                    grid_destination1.setVisibility(View.GONE);
                    btn_city1
                            .setBackgroundResource(R.drawable.icon_province);
                    grid_destination2.setVisibility(View.GONE);
                    btn_county1
                            .setBackgroundResource(R.drawable.icon_province);
                } else {
                    grid_destination0.setVisibility(View.GONE);
        ...
        btn_city1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (btn_province1.getText().equals("省份")) {
                    AlertDialog dialog = new AlertDialog.Builder(
                            CitySelectActivity.this)
                            .setMessage("请先选择省份")
                            .setPositiveButton("确定",
                    ...
                    if (!grid_destination1.isShown()) {
                        grid_destination1.setVisibility(View.VISIBLE);
                        btn_city1
                                .setBackgroundResource(R.drawable.icon_city);
                        grid_destination0.setVisibility(View.GONE);
                        btn_province1
        ...
        btn_county1.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (btn_city1.getText().equals("城市")&&(!btn_province1.getText().equals("省份"))) {
                    AlertDialog dialog = new AlertDialog.Builder(
                            CitySelectActivity.this)
                            .setMessage("请先选择城市")
                            .setPositiveButton("确定",
                    ...
                    dialog.show();
                } else if(btn_city1.getText().equals("城市")&&btn_province1.getText().equals("省份")){
                    AlertDialog dialog = new AlertDialog.Builder(
                            CitySelectActivity.this)
                            .setMessage("请先选择省份")
                            .setPositiveButton("确定",
                    ...
                    if (!grid_destination2.isShown()) {
                        grid_destination2.setVisibility(View.VISIBLE);
                        btn_county1
                                .setBackgroundResource(R.drawable.icon_city);
                        grid_destination0.setVisibility(View.GONE);
                        btn_province1
        ...
        grid_destination0.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                provinceId = arg2;
                TextView textView = (TextView) arg1
                        .findViewById(R.id.text_adapter_item);
                strProvince1 = (String) textView.getText();
                if (!btn_province1.getText().equals(strProvince)) {
                    grid_destination1.setVisibility(View.GONE);
                    btn_city1
                            .setBackgroundResource(R.drawable.icon_province);
                    grid_destination2.setVisibility(View.GONE);
                    btn_county1
                            .setBackgroundResource(R.drawable.icon_province);
                    btn_city1.setText("城市");
                    btn_county1.setText("区县");
                }
                Log.e("test", "province: " + arg2 + strProvince1);
                loadGridViewData(grid_destination0, grid_destination1,
                        city_adapter, city[arg2]);
                btn_province1.setText(strProvince1);
                btn_province1
                        .setBackgroundResource(R.drawable.icon_province);
            }
        });
        grid_destination1.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                cityId = arg2;
                TextView textView = (TextView) arg1
                        .findViewById(R.id.text_adapter_item);
                strCity1 = (String) textView.getText();
                if (!btn_city1.getText().equals(strCity1)) {
                    grid_destination2.setVisibility(View.GONE);
                    btn_county1
                            .setBackgroundResource(R.drawable.icon_province);
                    btn_county1.setText("区县");
                }
                btn_city1.setText(strCity1);
                btn_city1
                        .setBackgroundResource(R.drawable.icon_province);
                Log.e("test", "city: " + arg2 + strCity1);
                switch (provinceId) {
                    case 0:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfBeiJing[cityId]);
                        break;
                    case 1:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfTianJing[cityId]);
                        break;
                    case 2:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfHeBei[cityId]);
                        break;
                    case 3:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfShanXi1[cityId]);
                        break;
                    case 4:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfNeiMengGu[cityId]);
                        break;
                    case 5:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfLiaoNing[cityId]);
                        break;
                    case 6:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfJiLin[cityId]);
                        break;
                    case 7:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfHeiLongJiang[cityId]);
                        break;
                    case 8:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfShangHai[cityId]);
                        break;
                    case 9:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfJiangSu[cityId]);
                        break;
                    case 10:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfZheJiang[cityId]);
                        break;
                    case 11:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfAnHui[cityId]);
                        break;
                    case 12:
                        loadGridViewData(grid_destination1, grid_destination2,
                    ...
                    case 13:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfJiangXi[cityId]);
                        break;
                    case 14:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfShanDong[cityId]);
                        break;
                    case 15:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfHeNan[cityId]);
                        break;
                    case 16:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfHuBei[cityId]);
                        break;
                    case 17:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfHuNan[cityId]);
                        break;
                    case 18:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfGuangDong[cityId]);
                        break;
                    case 19:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfGuangXi[cityId]);
                        break;
                    case 20:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfHaiNan[cityId]);
                        break;
                    case 21:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfChongQing[cityId]);
                        break;
                    case 22:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfSiChuan[cityId]);
                        break;
                    case 23:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfGuiZhou[cityId]);
                        break;
                    case 24:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfYunNan[cityId]);
                        break;
                    case 25:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfXiZang[cityId]);
                        break;
                    case 26:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfShanXi2[cityId]);
                        break;
                    case 27:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfGanSu[cityId]);
                        break;
                    case 28:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfQingHai[cityId]);
                        break;
                    case 29:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfNingXia[cityId]);
                        break;
                    case 30:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfXinJiang[cityId]);
                        break;
                    case 31:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfHongKong[cityId]);
                        break;
                    case 32:
                        loadGridViewData(grid_destination1, grid_destination2,
                                county_adapter, countyOfAoMen[cityId]);
                        break;
                    case 33:
                        loadGridViewData(grid_destination1, grid_destination2,
        ...
        grid_destination2.setOnItemClickListener(new OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                TextView textView = (TextView) arg1
                        .findViewById(R.id.text_adapter_item);
                strCounty1 = (String) textView.getText();
                Log.e("test", "county: " + arg2 + strCounty1);
                btn_county1.setText(strCounty1);
                grid_destination2.setVisibility(View.GONE);
                btn_county1
                        .setBackgroundResource(R.drawable.icon_province);
            }
    ...
    private void selectAndChange(MyGridView myGridView,
                                 ArrayAdapter<CharSequence> adapter, int array) {
        myGridView.setVisibility(View.VISIBLE);
        adapter = ArrayAdapter.createFromResource(this, array,
                R.layout.grid_adapter_item);
        myGridView.setAdapter(adapter);
    }

    private void loadGridViewData(MyGridView myGridView0,
                                  MyGridView myGridView, ArrayAdapter<CharSequence> adapter, int array) {
        adapter = ArrayAdapter.createFromResource(this, array,
                R.layout.grid_adapter_item);
        myGridView.setAdapter(adapter);
        myGridView0.setVisibility(View.GONE);
    }

    private void initView() {
        btn_province0 = (Button) findViewById(R.id.btn_province);
        btn_province1 = (Button) findViewById(R.id.btn_province1);
        btn_city0 = (Button) findViewById(R.id.btn_city);
        btn_city1 = (Button) findViewById(R.id.btn_city1);
        btn_county0 = (Button) findViewById(R.id.btn_county);
        btn_county1 = (Button) findViewById(R.id.btn_county1);
        grid_start0 = (MyGridView) findViewById(R.id.gridview_start_with0);
        grid_destination0 = (MyGridView) findViewById(R.id.gridview_destination0);
        grid_start1 = (MyGridView) findViewById(R.id.gridview_start_with1);
        grid_destination1 = (MyGridView) findViewById(R.id.gridview_destination1);
        grid_start2 = (MyGridView) findViewById(R.id.gridview_start_with2);
        grid_destination2 = (MyGridView) findViewById(R.id.gridview_destination2);
    }
